...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--prefix' '/tmp/ruby' '--disable-install-doc' '--disable-install-rdoc' '--disable-install-capi' '--without-ext=tk,gdbm,dbm,dl,coverage' '--with-openssl-dir=/usr/local/override' 'CFLAGS=-I/usr/local/override/include' 'LDFLAGS=-L/usr/local/override/lib' 'CXXFLAGS=-I/usr/local/override/include'"
